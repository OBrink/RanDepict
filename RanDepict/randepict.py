...
class RandomDepictor:
    ...
    def get_random_cdk_rendering_settings(
            self,
            rendererModel,
            molecule):
        """
    ...
    def new_reaction_condition_elements(
            self
            ) -> Tuple[str, str, str]:
        """
